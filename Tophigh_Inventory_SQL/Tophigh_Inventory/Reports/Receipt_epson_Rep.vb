...
Public Class Receipt_epson_Rep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tophigh_Inventory.Receipt_epson_Rep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReceipt_epson_Rep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Receipt_epson_Rep = New Receipt_epson_Rep()
        rpt.Site = Me.Site
        Return rpt
    End Function
