...
Public Class POSClass
    ...
    Public Sub FillCombo()
        ...
        Try
            ...
            'POSForm.cbodata.Items.Clear()
            'POSForm.cbodata.Items.Add("")
            'POSForm.cbodata.Items.AddRange(names.ToArray)
    ...
    Public Sub FillDirectCombo()
        ...
        'create the SqlCommand object and set the sql query
        ''<-- optional
        Dim cmd As New SqlCommand("select pro_descrip from low_stock_v where location ='" & convertQuotes(MainForm.txtlocation.Text) & "'group by pro_descrip", conn) With {.CommandTimeout = 60}
        Dim names As New List(Of String)
        Try
            conn.Open()
            'create the SqlDataReader object to connect to our table
    ...
    Public Sub CheckMember()
        Try
            If POSForm.rbogen.Checked = True Then
                CheckData()
            Else
                CheckMemData()
            End If
    ...
    Public Sub CheckData()
        ...
        Try
            ...
            Dim cm As New SqlCommand() With {.CommandText = String.Format("Select * from low_stock_v Where bar_code='" & convertQuotes(POSForm.cbodata.Text) & "' and location='" & convertQuotes(MainForm.txtlocation.Text) & "'"), .Connection = conString}
    ...
    Public Sub FillDataBox()
        ...
        Try
            ...
            Dim cm As New SqlCommand() With {.CommandText = String.Format("Select * from low_stock_v Where pro_descrip like '%" & convertQuotes(POSForm.cbodata.Text) & "%' and location='" & convertQuotes(MainForm.txtlocation.Text) & "'"), .Connection = conString}
            ...
            If dr.HasRows Then
                ...
                POSForm.txtid.Text = dr.Item("pro_id")
                POSForm.txtName.Text = dr.Item("pro_descrip")
                POSForm.txtproduct.Text = dr.Item("pro_descrip")
                POSForm.txtamt.Text = dr.Item("sales_price")
                POSForm.txtrate.Text = dr.Item("sales_price")
                POSForm.txtunitcost.Text = dr.Item("unit_cost")
                POSForm.txtutot.Text = dr.Item("unit_cost")
                POSForm.txtbarcode.Text = dr.Item("bar_code")
                POSForm.txtstock.Text = dr.Item("avlpcs")
                POSForm.txtqty.Text = "1"
    ...
    Public Sub FillMemDataBox()
        ...
        Try
            ...
            If dr.HasRows Then
                ...
                POSForm.txtName.Text = dr.Item("pro_descrip")
                POSForm.txtproduct.Text = dr.Item("pro_descrip")
                POSForm.txtamt.Text = dr.Item("mem_sales_price")
                POSForm.txtrate.Text = dr.Item("mem_sales_price")
                POSForm.txtunitcost.Text = dr.Item("unit_cost")
                POSForm.txtutot.Text = dr.Item("unit_cost")
                POSForm.txtbarcode.Text = dr.Item("bar_code")
                POSForm.txtstock.Text = dr.Item("avlpcs")
    ...
    Public Sub LoadGridView()
        ...
        Try
            ...
            POSForm.dgvsales.ReadOnly = False
            POSForm.dgvsales.DataSource = dtInvoice
            POSForm.dgvsales.SelectionMode = DataGridViewSelectionMode.FullRowSelect

            POSForm.dgvsales.Columns(5).Visible = False
            POSForm.dgvsales.Columns(6).Visible = False
            POSForm.dgvsales.Columns(0).Visible = False
            POSForm.dgvsales.Columns(7).Visible = False
            POSForm.dgvsales.Columns(3).ReadOnly = True

            POSForm.dgvsales.ForeColor = Color.Black

            POSForm.dgvsales.DefaultCellStyle.SelectionBackColor = Color.AliceBlue
            POSForm.dgvsales.DefaultCellStyle.SelectionForeColor = Color.Black
            POSForm.dgvsales.DefaultCellStyle.WrapMode = DataGridViewTriState.[True]
            POSForm.dgvsales.AllowUserToResizeColumns = False
            POSForm.dgvsales.RowsDefaultCellStyle.BackColor = Color.AliceBlue
            POSForm.dgvsales.AlternatingRowsDefaultCellStyle.BackColor = Color.White
        ...
        Try
            ...
            Using con As SqlConnection = New SqlConnection(conString)
                Using sda As SqlDataAdapter = New SqlDataAdapter()
                    cmd.Connection = con
                    cmd.Parameters.Add("@pos_id", SqlDbType.VarChar).Value = POSForm.txtposid.Text
                    ...
                    Using dsposPrint As New DataSet
                        ...
                        report.Parameters("mycomp").Value = POSForm.txtcomp.Text
    ...
    Public Sub InsertCashSales()
        ...
        Try
            ...
            POSForm.dgvsales.AllowUserToAddRows = False
            ...
            For i As Integer = 0 To POSForm.dgvsales.Rows.Count - 1

                dgvItem = POSForm.dgvsales.Rows(i).Cells(1).Value
                dgvqty = POSForm.dgvsales.Rows(i).Cells(2).Value
                dgvrate = POSForm.dgvsales.Rows(i).Cells(3).Value
                dgvamount = POSForm.dgvsales.Rows(i).Cells(4).Value
                dgvsync = POSForm.dgvsales.Rows(i).Cells(7).Value

                Dim connetionString As String = ConfigurationManager.ConnectionStrings("dbconnection").ConnectionString
                Dim cnn As SqlConnection = New SqlConnection(connetionString)
                Dim cmd As New SqlCommand() With {.CommandType = CommandType.Text, .CommandText = "insert into cash_sales_t (pos_id,cash_num,cash_date,pay_meth,items,qty,rate,vat,amount,sale_disc,nettotal,amt_rece,amt_change,ent_time,customer,[user],sales_descript,card_check_num,[location]) values(@pos_id,@cash_num,@cash_date,@pay_meth,@items,@qty,@rate,@vat,@amount,@sale_disc,@nettotal,@amt_rece,@amt_change,@ent_time,@customer,@user,@sales_descript,@card_check_num,@location)"}
                cmd.Parameters.Add("@pos_id", SqlDbType.VarChar).Value = POSForm.txtposid.Text.Trim()
                cmd.Parameters.Add("@cash_num", SqlDbType.Int).Value = POSForm.mSaleNo.Text.Trim()
                cmd.Parameters.Add("@cash_date", SqlDbType.Date).Value = POSForm.dtSalesDate.Text.Trim()
                cmd.Parameters.Add("@pay_meth", SqlDbType.VarChar).Value = POSForm.cboPayMeth.Text.Trim()
                ...
                cmd.Parameters.Add("@vat", SqlDbType.Float).Value = POSForm.txtvat.Text.Trim()
                cmd.Parameters.Add("@amount", SqlDbType.Float).Value = dgvamount.Trim()
                cmd.Parameters.Add("@sale_disc", SqlDbType.Float).Value = POSForm.txtsaldisc.Text.Trim()
                cmd.Parameters.Add("@nettotal", SqlDbType.Float).Value = POSForm.txtTotal.Text.Trim()
                cmd.Parameters.Add("@amt_rece", SqlDbType.Float).Value = POSForm.txtreceive.Text.Trim()
                cmd.Parameters.Add("@amt_change", SqlDbType.Float).Value = POSForm.txtchange.Text.Trim()
                cmd.Parameters.Add("@ent_time", SqlDbType.VarChar).Value = POSForm.lblTime.Text.Trim()
                cmd.Parameters.Add("@customer", SqlDbType.VarChar).Value = POSForm.cboCustomer.Text.Trim()
                cmd.Parameters.Add("@user", SqlDbType.VarChar).Value = MainForm.lbluser.Text.Trim()
                cmd.Parameters.Add("@sales_descript", SqlDbType.VarChar).Value = "Todays Sales @ '" & POSForm.lblTime.Text & "'"
                cmd.Parameters.Add("@card_check_num", SqlDbType.VarChar).Value = POSForm.txtref.Text.Trim()
    ...
    Public Sub InsertMemsCashSales()
        ...
        Try
            ...
            For i As Integer = 0 To POSForm.dgvsales.Rows.Count - 1
                ...
                Dim connetionString As String = ConfigurationManager.ConnectionStrings("dbconnection").ConnectionString
                Dim cnn As SqlConnection = New SqlConnection(connetionString)
                Dim cmd As New SqlCommand() With {.CommandType = CommandType.Text, .CommandText = "insert into cash_sales_mems_t (pos_id,cash_num,cash_date,pay_meth,items,qty,rate,vat,amount,sale_disc,nettotal,amt_rece,amt_change,ent_time,customer,[user],sales_descript,card_check_num,[location]) values(@pos_id,@cash_num,@cash_date,@pay_meth,@items,@qty,@rate,@vat,@amount,@sale_disc,@nettotal,@amt_rece,@amt_change,@ent_time,@customer,@user,@sales_descript,@card_check_num,@location)"}
                cmd.Parameters.Add("@pos_id", SqlDbType.VarChar).Value = POSForm.txtposid.Text.Trim()
                cmd.Parameters.Add("@cash_num", SqlDbType.Int).Value = POSForm.mSaleNo.Text.Trim()
                cmd.Parameters.Add("@cash_date", SqlDbType.Date).Value = POSForm.dtSalesDate.Text.Trim()
                cmd.Parameters.Add("@pay_meth", SqlDbType.VarChar).Value = POSForm.cboPayMeth.Text.Trim()
    ...
    Public Sub InsertCogs()
        ...
        Try
            ...
            For i As Integer = 0 To POSForm.dgvsales.Rows.Count - 1
                ...
                dgvcogstot = POSForm.dgvsales.Rows(i).Cells(6).Value

                Dim connetionString As String = ConfigurationManager.ConnectionStrings("dbconnection").ConnectionString
                Dim cnn As SqlConnection = New SqlConnection(connetionString)
                Dim cmd As New SqlCommand() With {.CommandType = CommandType.StoredProcedure, .CommandText = "Insert_Journal"}
                cmd.Parameters.Add("@cash_code", SqlDbType.Int).Value = POSForm.mSaleNo.Text
                cmd.Parameters.Add("@jv_date", SqlDbType.Date).Value = POSForm.dtSalesDate.Text
                cmd.Parameters.Add("@coa_name", SqlDbType.VarChar).Value = POSForm.txtcogsAcc.Text
                cmd.Parameters.Add("@debit", SqlDbType.Float).Value = dgvcogstot.Trim()
                cmd.Parameters.Add("@credit", SqlDbType.Float).Value = "0"
                cmd.Parameters.Add("@ent_time", SqlDbType.VarChar).Value = POSForm.lblTime.Text
    ...
    Public Sub InsertInv()
        ...
        Try
            ...
            For i As Integer = 0 To POSForm.dgvsales.Rows.Count - 1
                ...
                cmd.Parameters.Add("@cash_code", SqlDbType.Int).Value = POSForm.mSaleNo.Text
                cmd.Parameters.Add("@jv_date", SqlDbType.Date).Value = POSForm.dtSalesDate.Text
                cmd.Parameters.Add("@coa_name", SqlDbType.VarChar).Value = POSForm.txtInvAcc.Text
    ...
    Public Sub InsertCash()
        ...
        Try
            ...
            cmd.Parameters.Add("@cash_code", SqlDbType.Int).Value = POSForm.mSaleNo.Text
            cmd.Parameters.Add("@jv_date", SqlDbType.Date).Value = POSForm.dtSalesDate.Text
            cmd.Parameters.Add("@coa_name", SqlDbType.VarChar).Value = POSForm.cboPayMeth.Text
            cmd.Parameters.Add("@debit", SqlDbType.Float).Value = POSForm.txtTotal.Text
            cmd.Parameters.Add("@credit", SqlDbType.Float).Value = "0"
            cmd.Parameters.Add("@ent_time", SqlDbType.VarChar).Value = POSForm.lblTime.Text
            cmd.Parameters.Add("@location", SqlDbType.VarChar).Value = MainForm.txtlocation.Text
            cmd.Connection = cnn
    ...
    Public Sub InsertIncome()
        ...
        Try
            ...
            cmd.Parameters.Add("@cash_code", SqlDbType.Int).Value = POSForm.mSaleNo.Text
            cmd.Parameters.Add("@jv_date", SqlDbType.Date).Value = POSForm.dtSalesDate.Text
            cmd.Parameters.Add("@coa_name", SqlDbType.VarChar).Value = POSForm.txtsalesAcc.Text
            cmd.Parameters.Add("@debit", SqlDbType.Float).Value = "0"
            cmd.Parameters.Add("@credit", SqlDbType.Float).Value = POSForm.txtTotal.Text
            cmd.Parameters.Add("@ent_time", SqlDbType.VarChar).Value = POSForm.lblTime.Text
            cmd.Parameters.Add("@location", SqlDbType.VarChar).Value = MainForm.txtlocation.Text
            cmd.Connection = cnn
    ...
    Public Sub InsertSalesDisc()
        ...
        Try
            ...
            cmd.Parameters.Add("@cash_code", SqlDbType.Int).Value = POSForm.mSaleNo.Text
            cmd.Parameters.Add("@jv_date", SqlDbType.Date).Value = POSForm.dtSalesDate.Text
            cmd.Parameters.Add("@coa_name", SqlDbType.VarChar).Value = POSForm.txtdiscAcc.Text
            cmd.Parameters.Add("@debit", SqlDbType.Float).Value = POSForm.txtsaldisc.Text
            cmd.Parameters.Add("@credit", SqlDbType.Float).Value = "0"
            cmd.Parameters.Add("@ent_time", SqlDbType.VarChar).Value = POSForm.lblTime.Text
            cmd.Parameters.Add("@location", SqlDbType.VarChar).Value = MainForm.txtlocation.Text
            cmd.Connection = cnn
    ...
    Public Sub InsertTaxPay()
        ...
        Try
            ...
            cmd.Parameters.Add("@cash_code", SqlDbType.Int).Value = POSForm.mSaleNo.Text
            cmd.Parameters.Add("@jv_date", SqlDbType.Date).Value = POSForm.dtSalesDate.Text
            cmd.Parameters.Add("@coa_name", SqlDbType.VarChar).Value = POSForm.txtTaxAcc.Text
            cmd.Parameters.Add("@debit", SqlDbType.Float).Value = "0"
            cmd.Parameters.Add("@credit", SqlDbType.Float).Value = POSForm.txtvat.Text
            cmd.Parameters.Add("@ent_time", SqlDbType.VarChar).Value = POSForm.lblTime.Text
            cmd.Parameters.Add("@location", SqlDbType.VarChar).Value = MainForm.txtlocation.Text
            cmd.Connection = cnn
    ...
    Public Sub UpdateShelfQty()
        ...
        Try
            ...
            For i As Integer = 0 To POSForm.dgvsales.Rows.Count - 1
                ...
                dgvid = POSForm.dgvsales.Rows(i).Cells(0).Value
                dgvqty = POSForm.dgvsales.Rows(i).Cells(2).Value
    ...
    Public Sub GetData()
        ...
        Try
            ...
            If POSForm.txtid.Text <> "" AndAlso POSForm.txtName.Text <> "" AndAlso POSForm.txtqty.Text <> "" AndAlso POSForm.txtrate.Text <> "" AndAlso POSForm.txtamt.Text <> "" AndAlso POSForm.txtunitcost.Text <> "" AndAlso POSForm.txtutot.Text <> "" AndAlso POSForm.txtsyncode.Text <> "" Then
                dtInvoice.Rows.Add(POSForm.txtid.Text, POSForm.txtName.Text, POSForm.txtqty.Text, POSForm.txtrate.Text, POSForm.txtamt.Text, POSForm.txtunitcost.Text, POSForm.txtutot.Text, POSForm.txtsyncode.Text)
            End If

            POSForm.txtName.Text = ""
            POSForm.txtid.Text = ""
            POSForm.cbodata.Text = ""
            POSForm.txtqty.Text = "1"
            POSForm.txtrate.Text = "0.00"
            POSForm.txtamt.Text = ""
            POSForm.txtunitcost.Text = ""
            POSForm.txtutot.Text = ""
    ...
    Public Sub CalGridData()
        ...
        Try
            ...
            For j As Integer = 0 To POSForm.dgvsales.Rows.Count - 1

                Dim icell2 As Double = POSForm.dgvsales.Rows(j).Cells("Qty").Value
                Dim icell3 As Double = POSForm.dgvsales.Rows(j).Cells("Rate").Value

                Dim icellResultCost As Double = icell2 * icell3

                POSForm.dgvsales.Rows(j).Cells("Amount").Value = icellResultCost.ToString("n2")
        ...
        Try
            ...
            For k As Integer = 0 To POSForm.dgvsales.Rows.Count - 1

                Dim icell2 As Double = POSForm.dgvsales.Rows(k).Cells("Qty").Value
                Dim icell5 As Double = POSForm.dgvsales.Rows(k).Cells("unitcost").Value

                Dim icellResultCost As Double = icell2 * icell5

                POSForm.dgvsales.Rows(k).Cells("COSGTotal").Value = icellResultCost.ToString("n2")
        ...
        Try
            ...
            For i As Decimal = 0 To POSForm.dgvsales.Rows.Count - 1
                totalSum += POSForm.dgvsales.Rows(i).Cells("Amount").Value
            Next

            POSForm.txtsubtot.Text = totalSum.ToString("n2")
    ...
    Public Sub FillCustName()
        ...
        Try
            ...
            POSForm.cboCustomer.Items.Clear()
            POSForm.cboCustomer.Items.Add("Walk in Customer")
            POSForm.cboCustomer.Items.AddRange(names.ToArray)
        Catch ex As Exception
    ...
    Public Sub GetCash()
        ...
        Try
            ...
            POSForm.cboPayMeth.Items.Clear()
            POSForm.cboPayMeth.Items.Add("")
            POSForm.cboPayMeth.Items.AddRange(names.ToArray)
    ...
    Public Sub GetSales()
        ...
        Try
            ...
            If dr.HasRows Then
                ...
                POSForm.txtsalesAcc.Text = dr.Item("coa_name")
    ...
    Public Sub GetCogs()
        ...
        Try
            ...
            If dr.HasRows Then
                ...
                POSForm.txtcogsAcc.Text = dr.Item("coa_name")
    ...
    Public Sub GetInvAcc()
        ...
        Try
            ...
            If dr.HasRows Then
                ...
                POSForm.txtInvAcc.Text = dr.Item("coa_name")
    ...
    Public Sub GetDiscAcc()
        ...
        Try
            ...
            If dr.HasRows Then
                ...
                POSForm.txtdiscAcc.Text = dr.Item("coa_name")
    ...
    Public Sub GetTaxAcc()
        ...
        Try
            ...
            If dr.HasRows Then
                ...
                POSForm.txtTaxAcc.Text = dr.Item("coa_name")
    ...
    Public Sub Getcustid()
        ...
        Try
            ...
            Dim cm As New SqlCommand() With {.CommandText = String.Format("Select * from customer_v Where supplier='" & convertQuotes(POSForm.cboCustomer.Text) & "'"), .Connection = conString}
            ...
            If dr.HasRows Then
                ...
                POSForm.txtcustid.Text = dr.Item("id")
    ...
    Public Sub GetVatValue()
        ...
        Try
            ...
            If dr.HasRows Then
                ...
                POSForm.txtvatval.Text = dr.Item("vat_num")
    ...
    Public Sub CompInfo()
        ...
        Try
            ...
            If dr.HasRows Then
                ...
                POSForm.txtcomp.Text = Comp + Environment.NewLine + strt + Environment.NewLine + cty + "," + "" + cunt + Environment.NewLine + WorkFon + Environment.NewLine + email + Environment.NewLine + web
    ...
    Public Sub GetSalesOrederData()
        ...
        Try
            ...
            Dim AdapterCategories As New SqlDataAdapter("CashOrder_v", connection)
            Dim AdapterProducts As New SqlDataAdapter("CashOrderDetails_v", connection)

            Dim dataSet11 As New DataSet()
            'Create DataTable objects for representing database's tables
            AdapterCategories.Fill(dataSet11, "CashOrder_v")
            AdapterProducts.Fill(dataSet11, "CashOrderDetails_v")

            'Set up a master-detail relationship between the DataTables
            Dim keyColumn As DataColumn = dataSet11.Tables("CashOrder_v").Columns("Number")
            Dim foreignKeyColumn As DataColumn = dataSet11.Tables("CashOrderDetails_v").Columns("Number")
            dataSet11.Relations.Add("CashOrder_vCashOrderDetails_v", keyColumn, foreignKeyColumn)

            'Bind the grid control to the data source
            SalesOrderReportForm.dgvsalesorder.DataSource = dataSet11.Tables("CashOrder_v")
            SalesOrderReportForm.dgvsalesorder.ForceInitialize()

            ' Make the grid read-only.
            SalesOrderReportForm.GridView1.OptionsBehavior.Editable = False
            ' Prevent the focused cell from being highlighted.
            SalesOrderReportForm.GridView1.OptionsSelection.EnableAppearanceFocusedCell = False
            ' Draw a dotted focus rectangle around the entire row.
            SalesOrderReportForm.GridView1.FocusRectStyle = DevExpress.XtraGrid.Views.Grid.DrawFocusRectStyle.RowFocus
    ...
    Public Sub AutoCompleteList()
        ...
        Try
            ...
            POSForm.lvdrop.RefreshDataSource()

            ' Create a connection object. 
            Dim Connection As New SqlConnection(ConfigurationManager.ConnectionStrings("dbconnection").ConnectionString)

            ' Create a data adapter. 
            Dim Adapter As New SqlDataAdapter("Select pro_descrip as Product, avlpcs as [Qty on hand],sales_price as Price from low_stock_v Where pro_descrip like '%" & convertQuotes(POSForm.cbodata.Text) & "%' and location='" & convertQuotes(MainForm.txtlocation.Text) & "'", Connection)
            ...
            POSForm.lvdrop.DataSource = dsProduct.Tables(0)

            ' Make the grid read-only.
            POSForm.GridView1.OptionsBehavior.Editable = False
            ' Prevent the focused cell from being highlighted.
            POSForm.GridView1.OptionsSelection.EnableAppearanceFocusedCell = False
            ' Draw a dotted focus rectangle around the entire row.
            POSForm.GridView1.FocusRectStyle = DevExpress.XtraGrid.Views.Grid.DrawFocusRectStyle.RowFocus
