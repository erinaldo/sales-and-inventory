...
Public Class POSClass3
    ...
    Public Sub FillCombo()
        ...
        ''<-- optional
        Dim cmd As New SqlCommand("select pro_descrip from shelve_t where location ='" & convertQuotes(MainForm.txtlocation.Text) & "'group by pro_descrip", conn) With {.CommandTimeout = 60}
        ...
        Try
            ...
            'POSForm3.cbodata.Items.Clear()
            'POSForm3.cbodata.Items.Add("")
            'POSForm3.cbodata.Items.AddRange(names.ToArray)
    ...
    Public Sub CheckMember()
        Try
            If POSForm3.rbogen.Checked = True Then
                CheckData()
            Else
                CheckMemData()
            End If
    ...
    Public Sub CheckData()
        ...
        Try
            ...
            Dim cm As New SqlCommand() With {.CommandText = String.Format("Select * from low_stock_v Where bar_code='" & convertQuotes(POSForm3.cbodata.Text) & "' and location='" & convertQuotes(MainForm.txtlocation.Text) & "'"), .Connection = conString}
    ...
    Public Sub FillDataBox()
        ...
        Try
            ...
            Dim cm As New SqlCommand() With {.CommandText = String.Format("Select * from low_stock_v Where pro_descrip like '%" & convertQuotes(POSForm3.cbodata.Text) & "%' and location='" & convertQuotes(MainForm.txtlocation.Text) & "'"), .Connection = conString}
            ...
            If dr.HasRows Then
                ...
                POSForm3.txtid.Text = dr.Item("pro_id")
                POSForm3.txtName.Text = dr.Item("pro_descrip")
                POSForm3.txtproduct.Text = dr.Item("pro_descrip")
                POSForm3.txtamt.Text = dr.Item("sales_price")
                POSForm3.txtrate.Text = dr.Item("sales_price")
                POSForm3.txtunitcost.Text = dr.Item("unit_cost")
                POSForm3.txtutot.Text = dr.Item("unit_cost")
                POSForm3.txtbarcode.Text = dr.Item("bar_code")
                POSForm3.txtstock.Text = dr.Item("avlpcs")
                POSForm3.txtqty.Text = "1"
    ...
    Public Sub FillMemDataBox()
        ...
        Try
            ...
            If dr.HasRows Then
                ...
                POSForm3.txtName.Text = dr.Item("pro_descrip")
                POSForm3.txtproduct.Text = dr.Item("pro_descrip")
                POSForm3.txtamt.Text = dr.Item("mem_sales_price")
                POSForm3.txtrate.Text = dr.Item("mem_sales_price")
                POSForm3.txtunitcost.Text = dr.Item("unit_cost")
                POSForm3.txtutot.Text = dr.Item("unit_cost")
                POSForm3.txtbarcode.Text = dr.Item("bar_code")
                POSForm3.txtstock.Text = dr.Item("avlpcs")
    ...
    Public Sub LoadGridView()
        ...
        Try
            ...
            POSForm3.dgvsales.ReadOnly = False
            POSForm3.dgvsales.DataSource = dtInvoice
            POSForm3.dgvsales.SelectionMode = DataGridViewSelectionMode.FullRowSelect

            POSForm3.dgvsales.Columns(5).Visible = False
            POSForm3.dgvsales.Columns(6).Visible = False
            POSForm3.dgvsales.Columns(0).Visible = False
            POSForm3.dgvsales.Columns(7).Visible = False
            POSForm3.dgvsales.Columns(3).ReadOnly = True

            POSForm3.dgvsales.ForeColor = Color.Black

            POSForm3.dgvsales.DefaultCellStyle.SelectionBackColor = Color.AliceBlue
            POSForm3.dgvsales.DefaultCellStyle.SelectionForeColor = Color.Black
            POSForm3.dgvsales.DefaultCellStyle.WrapMode = DataGridViewTriState.[True]
            POSForm3.dgvsales.AllowUserToResizeColumns = False
            POSForm3.dgvsales.RowsDefaultCellStyle.BackColor = Color.AliceBlue
            POSForm3.dgvsales.AlternatingRowsDefaultCellStyle.BackColor = Color.White
    ...
    Public Sub PrintDirectPOSMems()
        ...
        Try
            ...
            Using con As SqlConnection = New SqlConnection(conString)
                Using sda As SqlDataAdapter = New SqlDataAdapter()
                    cmd.Connection = con
                    cmd.Parameters.Add("@pos_id", SqlDbType.VarChar).Value = POSForm3.txtposid.Text
                    ...
                    Using dsposPrint As New DataSet
                        ...
                        report.Parameters("mycomp").Value = POSForm3.txtcomp.Text
        ...
        MainForm.SimpleButton1.PerformClick()
    ...
    Public Sub InsertCashSales()
        ...
        Try
            ...
            POSForm3.dgvsales.AllowUserToAddRows = False
            ...
            For i As Integer = 0 To POSForm3.dgvsales.Rows.Count - 1

                dgvItem = POSForm3.dgvsales.Rows(i).Cells(1).Value
                dgvqty = POSForm3.dgvsales.Rows(i).Cells(2).Value
                dgvrate = POSForm3.dgvsales.Rows(i).Cells(3).Value
                dgvamount = POSForm3.dgvsales.Rows(i).Cells(4).Value
                dgvsync = POSForm3.dgvsales.Rows(i).Cells(7).Value
                ...
                cmd.Parameters.Add("@pos_id", SqlDbType.VarChar).Value = POSForm3.txtposid.Text.Trim()
                cmd.Parameters.Add("@cash_num", SqlDbType.Int).Value = POSForm3.mSaleNo.Text.Trim()
                cmd.Parameters.Add("@cash_date", SqlDbType.Date).Value = POSForm3.dtSalesDate.Text.Trim()
                cmd.Parameters.Add("@pay_meth", SqlDbType.VarChar).Value = POSForm3.cboPayMeth.Text.Trim()
                ...
                cmd.Parameters.Add("@vat", SqlDbType.Float).Value = POSForm3.txtvat.Text.Trim()
                cmd.Parameters.Add("@amount", SqlDbType.Float).Value = dgvamount.Trim()
                cmd.Parameters.Add("@sale_disc", SqlDbType.Float).Value = POSForm3.txtsaldisc.Text.Trim()
                cmd.Parameters.Add("@nettotal", SqlDbType.Float).Value = POSForm3.txtTotal.Text.Trim()
                cmd.Parameters.Add("@amt_rece", SqlDbType.Float).Value = POSForm3.txtreceive.Text.Trim()
                cmd.Parameters.Add("@amt_change", SqlDbType.Float).Value = POSForm3.txtchange.Text.Trim()
                cmd.Parameters.Add("@ent_time", SqlDbType.VarChar).Value = POSForm3.lblTime.Text.Trim()
                cmd.Parameters.Add("@customer", SqlDbType.VarChar).Value = POSForm3.cboCustomer.Text.Trim()
                cmd.Parameters.Add("@user", SqlDbType.VarChar).Value = MainForm.lbluser.Text.Trim()
                cmd.Parameters.Add("@sales_descript", SqlDbType.VarChar).Value = "Todays Sales @ '" & POSForm3.lblTime.Text & "'"
                cmd.Parameters.Add("@card_check_num", SqlDbType.VarChar).Value = POSForm3.txtref.Text.Trim()
    ...
    Public Sub InsertCogs()
        ...
        Try
            ...
            For i As Integer = 0 To POSForm3.dgvsales.Rows.Count - 1
                ...
                dgvcogstot = POSForm3.dgvsales.Rows(i).Cells(6).Value

                Dim connetionString As String = ConfigurationManager.ConnectionStrings("dbconnection").ConnectionString
                Dim cnn As SqlConnection = New SqlConnection(connetionString)
                Dim cmd As New SqlCommand() With {.CommandType = CommandType.StoredProcedure, .CommandText = "Insert_Journal"}
                cmd.Parameters.Add("@cash_code", SqlDbType.Int).Value = POSForm3.mSaleNo.Text
                cmd.Parameters.Add("@jv_date", SqlDbType.Date).Value = POSForm3.dtSalesDate.Text
                cmd.Parameters.Add("@coa_name", SqlDbType.VarChar).Value = POSForm3.txtcogsAcc.Text
                cmd.Parameters.Add("@debit", SqlDbType.Float).Value = dgvcogstot.Trim()
                cmd.Parameters.Add("@credit", SqlDbType.Float).Value = "0"
                cmd.Parameters.Add("@ent_time", SqlDbType.VarChar).Value = POSForm3.lblTime.Text
    ...
    Public Sub InsertInv()
        ...
        Try
            ...
            For i As Integer = 0 To POSForm3.dgvsales.Rows.Count - 1
                ...
                cmd.Parameters.Add("@cash_code", SqlDbType.Int).Value = POSForm3.mSaleNo.Text
                cmd.Parameters.Add("@jv_date", SqlDbType.Date).Value = POSForm3.dtSalesDate.Text
                cmd.Parameters.Add("@coa_name", SqlDbType.VarChar).Value = POSForm3.txtInvAcc.Text
    ...
    Public Sub InsertCash()
        ...
        Try
            ...
            cmd.Parameters.Add("@cash_code", SqlDbType.Int).Value = POSForm3.mSaleNo.Text
            cmd.Parameters.Add("@jv_date", SqlDbType.Date).Value = POSForm3.dtSalesDate.Text
            cmd.Parameters.Add("@coa_name", SqlDbType.VarChar).Value = POSForm3.cboPayMeth.Text
            cmd.Parameters.Add("@debit", SqlDbType.Float).Value = POSForm3.txtTotal.Text
            cmd.Parameters.Add("@credit", SqlDbType.Float).Value = "0"
            cmd.Parameters.Add("@ent_time", SqlDbType.VarChar).Value = POSForm3.lblTime.Text
            cmd.Parameters.Add("@location", SqlDbType.VarChar).Value = MainForm.txtlocation.Text
            cmd.Connection = cnn
    ...
    Public Sub InsertIncome()
        ...
        Try
            ...
            cmd.Parameters.Add("@cash_code", SqlDbType.Int).Value = POSForm3.mSaleNo.Text
            cmd.Parameters.Add("@jv_date", SqlDbType.Date).Value = POSForm3.dtSalesDate.Text
            cmd.Parameters.Add("@coa_name", SqlDbType.VarChar).Value = POSForm3.txtsalesAcc.Text
            cmd.Parameters.Add("@debit", SqlDbType.Float).Value = "0"
            cmd.Parameters.Add("@credit", SqlDbType.Float).Value = POSForm3.txtTotal.Text
            cmd.Parameters.Add("@ent_time", SqlDbType.VarChar).Value = POSForm3.lblTime.Text
            cmd.Parameters.Add("@location", SqlDbType.VarChar).Value = MainForm.txtlocation.Text
            cmd.Connection = cnn
    ...
    Public Sub InsertSalesDisc()
        ...
        Try
            ...
            cmd.Parameters.Add("@cash_code", SqlDbType.Int).Value = POSForm3.mSaleNo.Text
            cmd.Parameters.Add("@jv_date", SqlDbType.Date).Value = POSForm3.dtSalesDate.Text
            cmd.Parameters.Add("@coa_name", SqlDbType.VarChar).Value = POSForm3.txtdiscAcc.Text
            cmd.Parameters.Add("@debit", SqlDbType.Float).Value = POSForm3.txtsaldisc.Text
            cmd.Parameters.Add("@credit", SqlDbType.Float).Value = "0"
            cmd.Parameters.Add("@ent_time", SqlDbType.VarChar).Value = POSForm3.lblTime.Text
            cmd.Parameters.Add("@location", SqlDbType.VarChar).Value = MainForm.txtlocation.Text
            cmd.Connection = cnn
    ...
    Public Sub InsertTaxPay()
        ...
        Try
            ...
            cmd.Parameters.Add("@cash_code", SqlDbType.Int).Value = POSForm3.mSaleNo.Text
            cmd.Parameters.Add("@jv_date", SqlDbType.Date).Value = POSForm3.dtSalesDate.Text
            cmd.Parameters.Add("@coa_name", SqlDbType.VarChar).Value = POSForm3.txtTaxAcc.Text
            cmd.Parameters.Add("@debit", SqlDbType.Float).Value = "0"
            cmd.Parameters.Add("@credit", SqlDbType.Float).Value = POSForm3.txtvat.Text
            cmd.Parameters.Add("@ent_time", SqlDbType.VarChar).Value = POSForm3.lblTime.Text
            cmd.Parameters.Add("@location", SqlDbType.VarChar).Value = MainForm.txtlocation.Text
            cmd.Connection = cnn
    ...
    Public Sub UpdateShelfQty()
        ...
        Try
            ...
            For i As Integer = 0 To POSForm3.dgvsales.Rows.Count - 1
                ...
                dgvid = POSForm3.dgvsales.Rows(i).Cells(0).Value
                dgvqty = POSForm3.dgvsales.Rows(i).Cells(2).Value
    ...
    Public Sub GetData()
        ...
        Try
            ...
            If POSForm3.txtid.Text <> "" AndAlso POSForm3.txtName.Text <> "" AndAlso POSForm3.txtqty.Text <> "" AndAlso POSForm3.txtrate.Text <> "" AndAlso POSForm3.txtamt.Text <> "" AndAlso POSForm3.txtunitcost.Text <> "" AndAlso POSForm3.txtutot.Text <> "" AndAlso POSForm3.txtsyncode.Text <> "" Then
                dtInvoice.Rows.Add(POSForm3.txtid.Text, POSForm3.txtName.Text, POSForm3.txtqty.Text, POSForm3.txtrate.Text, POSForm3.txtamt.Text, POSForm3.txtunitcost.Text, POSForm3.txtutot.Text, POSForm3.txtsyncode.Text)
            End If

            POSForm3.txtName.Text = ""
            POSForm3.txtid.Text = ""
            POSForm3.cbodata.Text = ""
            POSForm3.txtqty.Text = "1"
            POSForm3.txtrate.Text = "0.00"
            POSForm3.txtamt.Text = ""
            POSForm3.txtunitcost.Text = ""
            POSForm3.txtutot.Text = ""
    ...
    Public Sub CalGridData()
        ...
        Try
            ...
            For j As Integer = 0 To POSForm3.dgvsales.Rows.Count - 1

                Dim icell2 As Double = POSForm3.dgvsales.Rows(j).Cells("Qty").Value
                Dim icell3 As Double = POSForm3.dgvsales.Rows(j).Cells("Rate").Value

                Dim icellResultCost As Double = icell2 * icell3

                POSForm3.dgvsales.Rows(j).Cells("Amount").Value = icellResultCost.ToString("n2")
        ...
        Try
            ...
            For k As Integer = 0 To POSForm3.dgvsales.Rows.Count - 1

                Dim icell2 As Double = POSForm3.dgvsales.Rows(k).Cells("Qty").Value
                Dim icell5 As Double = POSForm3.dgvsales.Rows(k).Cells("unitcost").Value

                Dim icellResultCost As Double = icell2 * icell5

                POSForm3.dgvsales.Rows(k).Cells("COSGTotal").Value = icellResultCost.ToString("n2")
        ...
        Try
            ...
            For i As Decimal = 0 To POSForm3.dgvsales.Rows.Count - 1
                totalSum += POSForm3.dgvsales.Rows(i).Cells("Amount").Value
            Next

            POSForm3.txtsubtot.Text = totalSum.ToString("n2")
    ...
    Public Sub FillCustName()
        ...
        Try
            ...
            POSForm3.cboCustomer.Items.Clear()
            POSForm3.cboCustomer.Items.Add("Walk in Customer")
            POSForm3.cboCustomer.Items.AddRange(names.ToArray)
        Catch ex As Exception
    ...
    Public Sub FillMembers()
        ...
        Try
            ...
            POSForm3.cboCustomer.Items.Clear()
            POSForm3.cboCustomer.Items.Add("")
            POSForm3.cboCustomer.Items.AddRange(names.ToArray)
        Catch ex As Exception
    ...
    Public Sub GetCash()
        ...
        Try
            ...
            POSForm3.cboPayMeth.Items.Clear()
            POSForm3.cboPayMeth.Items.Add("")
            POSForm3.cboPayMeth.Items.AddRange(names.ToArray)
    ...
    Public Sub GetSales()
        ...
        Try
            ...
            If dr.HasRows Then
                ...
                POSForm3.txtsalesAcc.Text = dr.Item("coa_name")
    ...
    Public Sub GetCogs()
        ...
        Try
            ...
            If dr.HasRows Then
                ...
                POSForm3.txtcogsAcc.Text = dr.Item("coa_name")
    ...
    Public Sub GetInvAcc()
        ...
        Try
            ...
            If dr.HasRows Then
                ...
                POSForm3.txtInvAcc.Text = dr.Item("coa_name")
    ...
    Public Sub GetDiscAcc()
        ...
        Try
            ...
            If dr.HasRows Then
                ...
                POSForm3.txtdiscAcc.Text = dr.Item("coa_name")
    ...
    Public Sub GetTaxAcc()
        ...
        Try
            ...
            If dr.HasRows Then
                ...
                POSForm3.txtTaxAcc.Text = dr.Item("coa_name")
    ...
    Public Sub Getcustid()
        ...
        Try
            ...
            If dr.HasRows Then
                ...
                POSForm3.txtcustid.Text = dr.Item("id")
    ...
    Public Sub GetVatValue()
        ...
        Try
            ...
            If dr.HasRows Then
                ...
                POSForm3.txtvatval.Text = dr.Item("vat_num")
    ...
    Public Sub CompInfo()
        ...
        Try
            ...
            If dr.HasRows Then
                ...
                POSForm3.txtcomp.Text = Comp + Environment.NewLine + strt + Environment.NewLine + cty + "," + "" + cunt + Environment.NewLine + WorkFon + Environment.NewLine + email + Environment.NewLine + web
    ...
    Public Sub AutoCompleteList()
        ...
        Try
            ...
            POSForm3.lvdrop.RefreshDataSource()

            ' Create a connection object. 
            Dim Connection As New SqlConnection(ConfigurationManager.ConnectionStrings("dbconnection").ConnectionString)

            ' Create a data adapter. 
            Dim Adapter As New SqlDataAdapter("Select pro_descrip as Product,avlpcs as [Qty on hand],sales_price as Price from low_stock_v Where pro_descrip like '%" & convertQuotes(POSForm3.cbodata.Text) & "%' and location='" & convertQuotes(MainForm.txtlocation.Text) & "'", Connection)
            ...
            POSForm3.lvdrop.DataSource = dsProduct.Tables(0)

            ' Make the grid read-only.
            POSForm3.GridView1.OptionsBehavior.Editable = False
            ' Prevent the focused cell from being highlighted.
            POSForm3.GridView1.OptionsSelection.EnableAppearanceFocusedCell = False
            ' Draw a dotted focus rectangle around the entire row.
            POSForm3.GridView1.FocusRectStyle = DevExpress.XtraGrid.Views.Grid.DrawFocusRectStyle.RowFocus
