Public Class POSForm2

    Dim csal As New POSClass2
    Private rowIndex As Integer = 0
    Dim index As Integer

    Private Sub POSForm2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            cbodata.Focus()
            csal.GetPOStNum()
    ...
    Private Sub cbodata_SelectedIndexChanged_1(sender As Object, e As EventArgs)
        Try
            csal.CheckMember()
        Catch ex As Exception
