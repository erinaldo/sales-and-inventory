Public Class CreditSalesForm

    Dim csal As New InvoiceClass
    Private rowIndex As Integer = 0
    Dim index As Integer

    Private Sub CreditSalesForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub txtTotal_TextChanged(sender As Object, e As EventArgs) Handles txtTotal.TextChanged
        Try
            ...
            txttoword.Text = ConvertNumberToENG(txtTotal.Text)
        Catch ex As Exception
    ...
    Private Sub cboMemsName_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboMemsName.SelectedIndexChanged
        Try
            csal.Getmemid()
        Catch ex As Exception
    ...
    Private Sub cboMemsName_TextChanged(sender As Object, e As EventArgs) Handles cboMemsName.TextChanged
        Try
            csal.Getmemid()
        Catch ex As Exception
