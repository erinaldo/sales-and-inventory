Public Class ReceiveOrders2Form

    Dim itm As New Stock2Class
    Dim index As Integer

    Private Sub ReceiveOrders2Form_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            cbolocation.Text = MainForm.lbllocation.Text
            Timer1.Start()
