...
Public Class SuppliersListForm

    Dim sup As New SuppliersClass

    Private Sub SuppliersListForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub SuppliersListForm_Resize(sender As Object, e As EventArgs) Handles Me.Resize
        Try
    ...
    Private Sub txtid_TextChanged(sender As Object, e As EventArgs) Handles txtid.TextChanged
        Try
            ...
            ElseIf result = DialogResult.Yes Then
                SuppliersForm.txtgcode.Text = txtid.Text
                sup.GetSupData()
                sup.GetSupAddData()
